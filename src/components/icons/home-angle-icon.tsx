...
export default function HomeAngleIcon(props: SvgProps) {
    return (
        <Svg width="25" height="24" viewBox="0 0 25 24" fill="none" {...props}>
            <Path
                ...
                fill={props.fill ? props.fill : "url(#paint0_linear_5021_23345)"}
            />
            <Path
            ...
            />
            <Defs>
                <LinearGradient id="paint0_linear_5021_23345" x1="7.5" y1="6.5" x2="24" y2="27" gradientUnits="userSpaceOnUse">
